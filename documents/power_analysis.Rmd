...
## survival
labels <- ifelse(seq_along(unique(dat$n)) %% 2 == 0, "", unique(dat$n))
...
subtitle_text <- "$\\text{Coefficient of variation (CV) of simulated survival estimates. The blue line indicates a CV = 0.15}"
subtitle_text <- str_wrap(paste0(subtitle_text, param_text, ".$"),60)
```
